...
```{r summary-table}
rec_a  <- recommended_n(sim_summary, criterion = "rmse", threshold = 0.25,
                        param = "a", aggregate = "none")
rec_b1 <- recommended_n(sim_summary, criterion = "rmse", threshold = 0.25,
                        param = "b1", aggregate = "none")
rec_b3 <- recommended_n(sim_summary, criterion = "rmse", threshold = 0.25,
                        param = "b3", aggregate = "none")
